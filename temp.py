...
def capital(country):
    if cap.__contains__(country.title()):
        return jsonify({'Country':country.title(),'Capital':cap.get(country.title())})
    return jsonify({'Country':country,'Error':'country not found'})

@app.route('/country')
def country():
    if request.method=='GET':
        country=request.args.get('country')
        return redirect(url_for('capital',country=country))
